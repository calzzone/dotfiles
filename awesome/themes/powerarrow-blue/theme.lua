...
theme.taglist_font                              = "Incosolata Bold 7"

arrow1 											= "#7197E7"
arrow2 											= "#16A085" -- manjaro green

theme.fg_normal                                 = "#ffffff"
-- theme.fg_focus                                  = "#A77AC4" -- violet
theme.fg_focus                                  = "#ffffff" 
theme.fg_urgent                                 = "#b74822" -- brown
theme.bg_normal                                 = "#282a36" -- dark violet grey
-- theme.bg_focus                                  = "#FF79C6" -- pink
theme.bg_focus                                  = "#16A085" -- manjaro green
theme.bg_urgent                                 = "#3F3F3F"

theme.taglist_fg_focus                          = "#282a36"
theme.taglist_bg_focus                          = "#16A085"

theme.tasklist_bg_focus                         = "#000000"
-- theme.tasklist_fg_focus                         = "#A77AC4" -- light violet
theme.tasklist_fg_focus                         = "#ffffff" -- white

theme.border_width                              = 2
theme.border_normal                             = "#282a36"
-- theme.border_focus                              = "#F07178" -- border pink
theme.border_focus                              = "#4DB6AC" -- border manjaro green
theme.border_marked                             = "#CC9393" -- light pink-brown
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "Inconsolata Medium 11", fg = theme.fg_normal },
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Left widgets
            layout = wibox.layout.fixed.horizontal,
            --spr,
            arrow_right(arrow2, "alpha"),
            s.mytaglist,
            s.mypromptbox,
            arrow_right(theme.bg_normal, "alpha"),
            spr,
        },
        ...
        { -- Right widgets
           ...
           -- music
            ...
            -- volume
            arrow( "alpha", arrow1),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), arrow1),
			...
			-- CPU
            arrow(arrow1, arrow2),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), arrow2),
            ...
            -- batery
            -- arrow(arrow2, arrow1),
            -- wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), arrow1),

            -- wifi
            arrow(arrow2, arrow1),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), arrow1),

            -- clock
            arrow(arrow1, arrow2),
            wibox.container.background(wibox.container.margin(clock, 4, 8), arrow2),
